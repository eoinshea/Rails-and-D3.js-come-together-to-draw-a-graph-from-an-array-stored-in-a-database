...
//You can store a binary tree in a 1D array.
//
//      3
//    /   \
//   3     7
...
// 6  6   7  0
//
//The result array A is A = [1, 2, 3, 4, 5, 6, 7]
//
//The left child of a node i is given by 2*i + 1, the right child is given by 2*i + 2, first node is 0 indexed.
//
//    Exemple: left and right child of the 3rd node (index : 2) left child : 2*i + 1 = 2*2+1 = 5, A[5] = 6, correct ! right child : 2*i + 2 = 2*2 + 2 = 6, A[6] = 7, correct too !
//
//    So given this "algorithm" you can build a Java class that secretly handle the Tree in a 1D array !

//var nodeArray =  [3, 3, 7, 6, 6, 7, 0];
//
//
...
//        .attr("height", h);
//
//    d3.json(graphy, function (graphy) {
...
//                })
//                 .attr("id", function(d) {
//                    var newID =  "circleid_"+ String( d[i])  ;
//                    return newID  ;
//                });
//        }
//
